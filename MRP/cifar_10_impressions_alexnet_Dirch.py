		...
		for sam_no in tqdm(range(num_samples)):
			...
			for j in range(max_iter):
				...
				if j<max_iter-1:
					...
					print (type(net_logits))
					print ("net_logits: ", net_logits)
					print ("----------------------------------------")
					print (softmax_generated.shape)
					print (type(softmax_generated))
					print ("softmax_generated: ", softmax_generated)
					exit()
